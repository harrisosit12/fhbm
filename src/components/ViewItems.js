              ...
              >
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={this.RoomNo.bind(this)}
                    type="number"
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={this.TimeIn.bind(this)}
                    type="time"
                    className="form-control"
                    required
                  />
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={this.TimeOut.bind(this)}
                    type="time"
                    className="form-control"
                    required
                  />
                ...
                <button type="btn" className="btn btn-success btn-block">
                  Add
                </button>
              </form>
            </Modal.Body>
        ...
        rowActions = (
          <Fragment>
            ...
            <button
              ...
              data-toggle="modal"
              data-target={"#edit" + room._id}
              onClick={(id) => this.ShowEdit(room._id)}
            >
              Edit
            </button>
            <div
                  ...
                  <div class="modal-body">
                    ...
                    >
                      <div className="form-group">
                        ...
                        <input
                          value={this.state.editRoomNo}
                          onChange={this.EditRoomNo.bind(this)}
                          type="number"
                          className="form-control"
                        />
                      </div>
                      ...
                      <div className="form-group">
                        ...
                        <input
                          value={moment(this.state.editDate).format(
                            "YYYY-MM-DD"
                          )}
                      ...
                      <div className="form-group">
                        ...
                        <input
                          value={this.state.editTimeIn}
                          onChange={this.EditTimeIn.bind(this)}
                          type="time"
                          className="form-control"
                        />
                      </div>
                      ...
                      <div className="form-group">
                        ...
                        <input
                          ...
                          onChange={this.EditTimeOut.bind(this)}
                          type="time"
                          className="form-control"
                        />
                      </div>
                      ...
                      <div className="form-group">
                        ...
                        <input
                          ...
                          onChange={this.EditPrice.bind(this)}
                          type="number"
                          className="form-control"
                        />
                      </div>
                      ...
                      <div className="form-group">
                        <label htmlFor="txt-description">
                          Edit Availability
                        </label>

                        <select
                          value={this.state.editAvailability}
                          onChange={this.EditAvailability.bind(this)}
                          className="form-control"
                        >
                          <option value={this.state.editAvailability}>
                            {this.state.editAvailability}
                          </option>
            ...
            <Button
              ...
              onClick={(id) => this.ShowDelete(room._id)}
            >
              Delete
            </Button>
            ...
            >
              ...
              <Modal.Footer>
                <Button
                  variant="danger"
                  onClick={(id) => this.Delete(this.state.editId)}
                >
                  Delete
                </Button>
                <Button variant="success" onClick={this.CloseDelete.bind(this)}>
                  Cancel
                </Button>
              </Modal.Footer>
            </Modal>
          ...
          if (room.isRequested == 0) {
            rowActions = (
              <Fragment>
                <Button
                  ...
                  onClick={(id) => this.ShowBook(room._id)}
                >
                  Book this Room?
                </Button>
                ...
                <Modal
                  ...
                  onHide={this.CloseBook.bind(this)}
                >
                  <Modal.Header>
                    <Modal.Title>
                      Book Room #{this.state.editRoomNo} ?
                    </Modal.Title>
                  </Modal.Header>

                  <Modal.Body>
                    <form
                      onSubmit={this.Book.bind(this)}
                      encType="multipart/form-data"
                    >
                      ...
                      <div className="input-group mb-3">
                        ...
                        <input
                          value={moment(this.state.editDate).format("LL")}
                          onChange={this.EditDate.bind(this)}
                          type="text"
                          className="form-control"
                          min="2019-01-01"
                      ...
                      <button
                        ...
                        className="btn btn-success btn-block"
                      >
                        Book This Room (Pay using Stripe)
                      </button>
                    </form>
                  </Modal.Body>
                  ...
                  <Modal.Footer>
                    <Button
                      variant="danger"
                      className="btn btn-success btn-block"
                      onClick={this.CloseBook.bind(this)}
                    >
                      Cancel
                    </Button>
                  </Modal.Footer>
            ...
            rowActions = (
              <Fragment>
                <Button
                  className="btn btn-danger btn-block"
                  onClick={(id) => this.ShowConfirm(room._id)}
                >
                  Cancel Booking?
                </Button>
                ...
                >
                  <Modal.Header>
                    <Modal.Title>
                      Cancel Booking on Room # {room.roomNo}?
                    </Modal.Title>
                  </Modal.Header>
                  ...
                  <Modal.Footer>
                    <Button variant="danger" onClick={this.Cancel.bind(this)}>
                      Yes
                    </Button>
          ...
          if (room.availability == "Available") {
            l = (
              <button
                ...
                onClick={(id) => this.Approve(room._id)}
              >
                Approve
              </button>
            );
        ...
        <Fragment>
          <tr>
            ...
            <td>
              ...
              >
                <Modal.Header closeButton>{room.roomNo}</Modal.Header>

                <Modal.Body>
                  <img
                    src="https://content2.jdmagicbox.com/comp/visakhapatnam/z2/0891px891.x891.180414114311.j3z2/catalogue/parinaya-function-hall-kancharapalem-visakhapatnam-banquet-halls-yfjjy.jpg?interpolation=lanczos-none&output-format=jpg&resize=1024:370&crop=1024:370px;*,*"
                    width="100%"
